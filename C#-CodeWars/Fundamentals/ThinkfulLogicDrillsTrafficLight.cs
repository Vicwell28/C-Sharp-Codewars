...
{
	internal class ThinkfulLogicDrillsTrafficLight
	{
		...
		static public string thinkfulLogicDrillsTrafficLight(string c) => c.Equals("green") ? "yellow" : c.Equals("yellow") ? "red"  : "green";
	}
}
